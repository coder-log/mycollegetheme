...
<div class="page-banner">
    ...
    ?>
        ...
        <p><a class="metabox__blog-home-link" href="<?php echo get_permalink($theParentID) ?>"><i class=
        "fa fa-home" aria-hidden="true"></i> Back to <?php echo get_the_title($theParentID) ?></a> <span class=
